...
impl AiDisclosureLevel {
    /// Map from CPOP's `AiExtent` to W3C AI Content Disclosure level.
    ...
    /// Map from CPOP's declaration to IPTC Digital Source Type URI.
...
/// NIST AI RMF 1.0 subcategories that CPOP evidence addresses.
...
/// A single NIST AI RMF subcategory with CPOP's coverage status.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct NistSubcategory {
    ...
    /// How CPOP addresses this subcategory.
    pub cpop_coverage: String,
}

/// Generate the NIST AI RMF mapping for a CPOP evidence packet.
...
/// ISO/IEC 42001 Annex A controls relevant to CPOP.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Iso42001Mapping {
    pub controls: Vec<Iso42001Control>,
}

/// A single ISO 42001 Annex A control with CPOP coverage.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Generate the ISO 42001 mapping for CPOP.
...
/// Creative rights compliance status derived from a CPOP declaration.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Comprehensive standards compliance report for a CPOP evidence packet.
#[derive(Debug, Clone, Serialize, Deserialize)]
