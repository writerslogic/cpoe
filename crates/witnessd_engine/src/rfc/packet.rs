...
impl ProfileDeclaration {
    ...
    pub fn core() -> Self {
        Self {
            tier: 1,
            uri: "urn:ietf:params:rats:pop:profile:core".to_string(),
    ...
    pub fn enhanced() -> Self {
        Self {
            tier: 2,
            uri: "urn:ietf:params:rats:pop:profile:enhanced".to_string(),
            enabled_features: None,
            implementation_id: None,
        }
    }
    ...
    pub fn maximum() -> Self {
        Self {
            tier: 3,
            uri: "urn:ietf:params:rats:pop:profile:maximum".to_string(),
            enabled_features: None,
            implementation_id: None,
        }
    }
