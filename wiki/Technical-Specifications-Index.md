...
CPOP is built on several core cryptographic and architectural protocols. These documents detail the low-level implementation of the Proof-of-Process (PoP) system.
...
- **[[Persistence & Fault Tolerance]]**: How CPOP manages its local event database and recovery mechanisms.

## Schemas (JSON)

- [evidence-v1.json](https://github.com/writerslogic/cpop/blob/main/docs/schemas/evidence-v1.json)
- [declaration-v1.json](https://github.com/writerslogic/cpop/blob/main/docs/schemas/declaration-v1.json)
- [war-block-v1.json](https://github.com/writerslogic/cpop/blob/main/docs/schemas/war-block-v1.json)
