# CPoE Audit — Completed & Resolved Items
...
- **File**: `crates/cpoe_engine/src/writersproof/client.rs:24`
...
- **Fix**: Add `name = "cpoe_cli"` to the exception block
- **Effort**: small
- [x] Fix applied

### B3. cpoe_protocol missing rust-version
- **File**: `crates/cpoe_protocol/Cargo.toml`
...
- **File**: `apps/cpoe_cli/src/cmd_config.rs` (was main.rs:3115 pre-split)
...
- **File**: `crates/cpoe_engine/src/sentinel/ipc_handler.rs:162`
...
- **File**: `apps/cpoe_cli/src/cmd_verify.rs` (was main.rs:1841)
...
- **File**: `crates/cpoe_engine/src/tpm/software.rs:28`
...
- **File**: `apps/cpoe_cli/src/cmd_export.rs:98` (was main.rs:1263)
...
- **Files**: `crates/cpoe_engine/src/mmr/proof.rs:30,44,48,57` (InclusionProof::verify), `mmr/proof.rs:316,320,329` (RangeProof::verify)
...
- **File**: `crates/cpoe_engine/src/tpm/secure_enclave.rs:735`
...
- **File**: `crates/cpoe_engine/src/crypto/obfuscated.rs:33,49`
...
- **File**: `crates/cpoe_engine/src/identity/mnemonic.rs:25`
...
- **File**: `apps/cpoe_cli/src/cmd_watch.rs:362`
...
- **File**: `apps/cpoe_cli/src/cmd_watch.rs` (was main.rs:3783)
...
- **File**: `crates/cpoe_engine/src/sentinel/shadow.rs:39`
...
- **File**: `crates/cpoe_engine/src/engine.rs:49`
...
- **File**: `crates/cpoe_engine/src/engine.rs:212-235`
...
- **File**: `crates/cpoe_engine/src/sentinel/core.rs:304-407`
...
- **File**: `crates/cpoe_engine/src/checkpoint.rs:272`
...
- **File**: `crates/cpoe_engine/src/ffi/system.rs:34`
...
- **File**: `apps/cpoe_cli/src/native_messaging_host.rs` (457 lines)
...
- **File**: `crates/cpoe_engine/src/crypto/obfuscation.rs:34`
...
- **File**: `crates/cpoe_engine/src/analysis/labyrinth.rs:208-209`
...
- **File**: `crates/cpoe_engine/src/writersproof/client.rs`
...
- **File**: `crates/cpoe_engine/src/wal.rs:599-606`
...
- **File**: `crates/cpoe_engine/src/config.rs:530-534`
...
- **File**: `crates/cpoe_engine/src/identity/mnemonic.rs:24`
...
- **File**: `crates/cpoe_engine/src/sealed_identity.rs:155,309`
...
- **File**: `crates/cpoe_engine/src/wal.rs:250,338,482`
...
- **File**: `crates/cpoe_engine/src/wal.rs:637`
...
- **Files**: `crates/cpoe_engine/src/vdf/proof.rs:90`, `vdf/params.rs:45`
...
- **Files**: `crates/cpoe_engine/src/mmr/proof.rs:77,85,91,365,375,383,389` (u16 truncation), `mmr/proof.rs:210` (subtraction underflow)
...
- **Files**: `crates/cpoe_engine/src/presence.rs:193,282`, `vdf/timekeeper.rs:70`
...
- **File**: `apps/cpoe_cli/src/cmd_export.rs:259`
...
- **Files**: `crates/cpoe_engine/src/keyhierarchy/migration.rs:86-94`, `keyhierarchy/puf.rs:18-22`
...
- **File**: `apps/cpoe_cli/src/native_messaging_host.rs:135`
...
- **File**: `crates/cpoe_engine/src/vdf/proof.rs:112-113`
...
- **File**: `crates/cpoe_engine/src/sentinel/core.rs:272-318`
...
- **File**: `crates/cpoe_engine/src/sentinel/daemon.rs:78`
...
- **Files**: `crates/cpoe_engine/src/wal.rs:334`, `wal.rs:473`, `wal.rs:483`, `wal.rs:489`
...
- **File**: `crates/cpoe_engine/src/wal.rs:142-147`
...
- **Files**: `crates/cpoe_engine/src/keyhierarchy/session.rs:280`, `keyhierarchy/session.rs:309`
...
- **File**: `crates/cpoe_engine/src/engine.rs:82-84`
...
- **Files**: `crates/cpoe_engine/src/tpm/secure_enclave.rs:465,469`
...
- **File**: `crates/cpoe_engine/src/checkpoint.rs:887-889`
...
- **File**: `crates/cpoe_engine/src/sealed_identity.rs:367-374`
...
- **File**: `apps/cpoe_cli/src/util.rs:77-80`
...
- [-] Accepted risk — RSA is a transitive dependency via TPM crates (tss-esapi); no direct RSA usage in CPoE. Marvin Attack requires chosen-ciphertext access to RSA decryption oracle, which doesn't apply to our signing-only TPM usage.
...
- **File**: `crates/cpoe_jitter/Cargo.toml:20`
...
- [x] Verified no_std compilation with `cargo build -p cpoe_jitter --no-default-features`

### J-M1. `compute_jitter` can overflow u32 with adversarial jmin+range
- **Files**: `crates/cpoe_jitter/src/phys.rs:225`, `crates/cpoe_jitter/src/pure.rs:65`
...
- **File**: `crates/cpoe_jitter/src/evidence.rs:317-336`
...
- **File**: `crates/cpoe_jitter/src/phys.rs:168`
...
- **File**: `crates/cpoe_jitter/src/phys.rs:101-106`
...
- **File**: `crates/cpoe_jitter/Cargo.toml:5`
...
- **File**: `crates/cpoe_jitter/src/lib.rs:123-132`
...
## cpoe_macos (Swift GUI App)

### MAC-H1. SecRandomCopyBytes result discarded in nonce generation
- **File**: `apps/cpoe_macos/cpoe/CPoEBridge.swift:914`
...
- **File**: `apps/cpoe_macos/CPoESafariExtension/SafariWebExtensionHandler.swift`
...
- **File**: `apps/cpoe_macos/CPoESafariExtension/SafariWebExtensionHandler.swift:99,111,172-173`
...
- **File**: `apps/cpoe_macos/cpoe/BrowserExtensionService.swift:18-19`
...
- **File**: `apps/cpoe_macos/cpoe/SecurityScopedBookmark.swift:78`
...
## cpoe_windows (C#/WinUI App)

### WIN-C1. Lock screen bypass when no password set
- **File**: `winui/CPoE/Dialogs/LockScreenDialog.xaml.cs:141-147`
...
- **File**: `winui/CPoE/Pages/OnboardingPage.xaml.cs:246-263`
...
- **File**: `winui/CPoE/Services/IpcClient.cs:632`
...
- **File**: `winui/CPoE/Services/IpcClient.cs:105`
...
- **File**: `winui/CPoE/Services/IpcClient.cs:192-214`
...
- **File**: `winui/CPoE/Dialogs/LockScreenDialog.xaml.cs:186`
...
- **File**: `winui/CPoE/Dialogs/MnemonicRecoveryDialog.xaml.cs:84`
...
- **File**: `winui/CPoE/Services/CPoEBridge.cs:34`
...
- **File**: `winui/CPoE/Services/SecurityService.cs:183-194`
...
- **File**: `winui/CPoE/Services/IpcClient.cs:387-426`
...
- **File**: `winui/CPoE/Services/SecurityService.cs:100-128`
...
- **File**: `winui/CPoE/Services/AppLogger.cs:146-149`
...
- **File**: `winui/CPoE/Services/SettingsService.cs:62-65,105-108`
...
- **File**: `crates/cpoe_protocol/src/evidence.rs:45`
...
- **Impact**: Two versions of `rand` in the dependency tree. Protocol and jitter crates use `thread_rng()` instead of project-convention `StdRng::from_os_rng()` (a 0.9 API). 4 production sites: `identity.rs:142`, `evidence.rs:33,79`, `cpoe_jitter/src/lib.rs:329`.
- **Fix**: Upgrade both crates to `rand = "0.9"`, replace `thread_rng().fill_bytes()` with `StdRng::from_os_rng()` at all 4 sites
- **Effort**: small
- [x] cpoe_protocol upgraded — rand 0.9, thread_rng() → StdRng::from_os_rng()
- [x] cpoe_jitter upgraded — rand 0.9, thread_rng() → StdRng::from_os_rng()
...
### REL-C2. cpoe_protocol version 0.1.0 diverges from workspace 0.2.0 (CRITICAL)
- **File**: `crates/cpoe_protocol/Cargo.toml:3`
...
- **File**: `apps/cpoe_cli/install.sh:7-8`
...
- **File**: `Makefile:13`
- **Fix**: Changed `CPoE_MOCK_KEYCHAIN=1` → `CPoE_NO_KEYCHAIN=1`
- [x] Fix applied

### BE-L1. activeTab permission still present in manifest (MEDIUM)
- **File**: `apps/cpoe_cli/browser-extension/manifest.json:8`
- **Fix**: Removed `"activeTab"`, replaced with `"alarms"` in permissions array
- [x] Fix applied

### BE-M7. No CSP in manifest (MEDIUM)
- **File**: `apps/cpoe_cli/browser-extension/manifest.json`
...
- **File**: `crates/cpoe_engine/src/engine.rs:352`
...
- **File**: `apps/cpoe_cli/src/native_messaging_host.rs:362-411`
...
- **File**: `apps/cpoe_cli/browser-extension/options.js`
...
- **File**: `apps/cpoe_cli/browser-extension/content.js`
...
- **File**: `crates/cpoe_jitter/README.md`
...
- **File**: `crates/cpoe_jitter/src/model.rs`
