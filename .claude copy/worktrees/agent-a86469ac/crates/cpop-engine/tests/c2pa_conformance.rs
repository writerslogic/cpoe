...
//! C2PA conformance tests for CPOP's C2PA output.
//!
...
use cpop_engine::war::profiles::c2pa::{self, ASSERTION_LABEL};
use cpop_engine::war::profiles::standards::AiDisclosureLevel;
use cpop_engine::war::Block;
