...
In the age of generative AI, the "Authorship Gap" is the growing distance between a digital signature (which proves key possession) and the creative process (which proves human effort). CPOP exists to bridge this gap through **[[Glossary#PoP|Proof-of-Process (PoP)]]**.
...
- **Non-Surveillance:** We reject "proctoring" or screen-recording. Authenticity must be proven through cryptographic physics ([[Glossary#VDF|VDFs]], [[Glossary#Jitter Seal|Jitter]]), not through the invasion of privacy.
