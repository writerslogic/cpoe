...
use cpop_jitter::{HybridEngine, PhysJitter, PureJitter};

fn main() {
    let phys = PhysJitter::new(8).with_jitter_range(1000, 2000).unwrap();

    let pure = PureJitter::new(1000, 2000).unwrap();
