...
fn test_session_detection() {
    ...
    events[5].timestamp_ns = events[4].timestamp_ns + 3_600_000_000_000; 
...
fn test_cross_modal_temporal_drift_fails_on_misaligned_spans() {
    ...
    let jitter = make_jitter(30, 500_000_000_000, 100_000_000); 
    let input = cross_modal::CrossModalInput {
        events: &events,
