...
pub fn draw_flow_chart(
    ...
    for (i, point) in flow.iter().enumerate() {
        ...
        let color = match point.phase.as_str() {
            "drafting" => Color::Rgb(Rgb::new(0.298, 0.686, 0.314, None)), 
            "revising" => Color::Rgb(Rgb::new(0.129, 0.588, 0.953, None)), 
            "polish" => Color::Rgb(Rgb::new(0.612, 0.153, 0.691, None)),   
            "pause" => Color::Rgb(Rgb::new(0.878, 0.878, 0.878, None)),    
            _ => Color::Rgb(Rgb::new(0.471, 0.565, 0.612, None)),          
        };
