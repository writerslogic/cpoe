...
fn test_build_get_random_command() {
    ...
    assert_eq!(cmd[2..6], [0x00, 0x00, 0x00, 0x0C]); 
...
fn test_parse_get_random_response_tpm_error() {
    ...
    response.extend_from_slice(&0x101u32.to_be_bytes()); 
